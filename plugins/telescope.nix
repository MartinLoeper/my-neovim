{ pkgs, ... }: {
  ...
  config = ''
        ...
        vim.keymap.set('n', '<leader>gw', telescope.extensions.git_worktree.git_worktree, { desc = '[G]oto Git [W]orktree' })
        vim.keymap.set('n', '<leader>gc', telescope.extensions.git_worktree.create_git_worktree, { desc = '[G]oto Git Worktree [C]reation' })
